...
export type Mutation = {
  ...
  /** Deletes zero or more records from the `pentagrams_nodes` collection */
  deleteFrompentagrams_nodesCollection: Pentagrams_NodesDeleteResponse;
  ...
  /** Adds one or more `pentagrams_nodes` records to the collection */
  insertIntopentagrams_nodesCollection?: Maybe<Pentagrams_NodesInsertResponse>;
  ...
  /** Updates zero or more records in the `pentagrams_nodes` collection */
  updatepentagrams_nodesCollection: Pentagrams_NodesUpdateResponse;
...
/** The root type for creating and mutating data */
export type MutationDeleteFrompentagrams_NodesCollectionArgs = {
  atMost?: Scalars['Int']['input'];
  filter?: InputMaybe<Pentagrams_NodesFilter>;
};
...
/** The root type for creating and mutating data */
export type MutationInsertIntopentagrams_NodesCollectionArgs = {
...
/** The root type for creating and mutating data */
export type MutationUpdatepentagrams_NodesCollectionArgs = {
  atMost?: Scalars['Int']['input'];
  filter?: InputMaybe<Pentagrams_NodesFilter>;
  set: Pentagrams_NodesUpdateInput;
};
...
export type Query = {
  ...
  /** A pagable collection of type `pentagrams_nodes` */
  pentagrams_nodesCollection?: Maybe<Pentagrams_NodesConnection>;
...
/** The root type for querying data */
export type QueryPentagrams_NodesCollectionArgs = {
  after?: InputMaybe<Scalars['Cursor']['input']>;
  before?: InputMaybe<Scalars['Cursor']['input']>;
  filter?: InputMaybe<Pentagrams_NodesFilter>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  orderBy?: InputMaybe<Array<Pentagrams_NodesOrderBy>>;
};
...
export type OeuvresPentagrams_NodesCollectionArgs = {
  after?: InputMaybe<Scalars['Cursor']['input']>;
  before?: InputMaybe<Scalars['Cursor']['input']>;
  filter?: InputMaybe<Pentagrams_NodesFilter>;
  first?: InputMaybe<Scalars['Int']['input']>;
...
export type PentagramsPentagrams_NodesCollectionArgs = {
  after?: InputMaybe<Scalars['Cursor']['input']>;
  before?: InputMaybe<Scalars['Cursor']['input']>;
  filter?: InputMaybe<Pentagrams_NodesFilter>;
  first?: InputMaybe<Scalars['Int']['input']>;
...
export type Pentagrams_Nodes = Node & {
  __typename?: 'pentagrams_nodes';
...
export type Pentagrams_NodesConnection = {
  __typename?: 'pentagrams_nodesConnection';
  edges: Array<Pentagrams_NodesEdge>;
  pageInfo: PageInfo;
};

export type Pentagrams_NodesDeleteResponse = {
  __typename?: 'pentagrams_nodesDeleteResponse';
  /** Count of the records impacted by the mutation */
  affectedCount: Scalars['Int']['output'];
  /** Array of records impacted by the mutation */
  records: Array<Pentagrams_Nodes>;
};

export type Pentagrams_NodesEdge = {
  __typename?: 'pentagrams_nodesEdge';
  cursor: Scalars['String']['output'];
  node: Pentagrams_Nodes;
};

export type Pentagrams_NodesFilter = {
  /** Returns true only if all its inner filters are true, otherwise returns false */
  and?: InputMaybe<Array<Pentagrams_NodesFilter>>;
  ...
  nodeId?: InputMaybe<IdFilter>;
  /** Negates a filter */
  not?: InputMaybe<Pentagrams_NodesFilter>;
  oeuvre_id?: InputMaybe<UuidFilter>;
  /** Returns true if at least one of its inner filters is true, otherwise returns false */
  or?: InputMaybe<Array<Pentagrams_NodesFilter>>;
  pentagram_id?: InputMaybe<UuidFilter>;
};

export type Pentagrams_NodesInsertInput = {
...
export type Pentagrams_NodesInsertResponse = {
  __typename?: 'pentagrams_nodesInsertResponse';
  /** Count of the records impacted by the mutation */
  affectedCount: Scalars['Int']['output'];
  /** Array of records impacted by the mutation */
  records: Array<Pentagrams_Nodes>;
...
export type Pentagrams_NodesOrderBy = {
  angle?: InputMaybe<OrderByDirection>;
  created_at?: InputMaybe<OrderByDirection>;
...
export type Pentagrams_NodesUpdateInput = {
  angle?: InputMaybe<Scalars['Int']['input']>;
  created_at?: InputMaybe<Scalars['Datetime']['input']>;
  distance?: InputMaybe<Scalars['Int']['input']>;
  id?: InputMaybe<Scalars['UUID']['input']>;
...
export type Pentagrams_NodesUpdateResponse = {
  __typename?: 'pentagrams_nodesUpdateResponse';
  /** Count of the records impacted by the mutation */
  affectedCount: Scalars['Int']['output'];
  /** Array of records impacted by the mutation */
  records: Array<Pentagrams_Nodes>;
...
export type PentagramsNodesInfoFragment = { __typename: 'pentagrams_nodesConnection', edges: Array<{ __typename: 'pentagrams_nodesEdge', node: { __typename: 'pentagrams_nodes', id: string, angle: number, distance: number, oeuvres: { __typename: 'oeuvres', id: string, title: string, description?: string | null, release_date: string, oeuvres_artistsCollection?: { __typename: 'oeuvres_artistsConnection', edges: Array<{ __typename: 'oeuvres_artistsEdge', node: { __typename: 'oeuvres_artists', artists: { __typename: 'artists', id: string, name: string, birthdate?: string | null, bio?: string | null } } }> } | null, oeuvres_genresCollection?: { __typename: 'oeuvres_genresConnection', edges: Array<{ __typename: 'oeuvres_genresEdge', node: { __typename: 'oeuvres_genres', genres: { __typename: 'genres', id: string, name?: string | null } } }> } | null } } }> };

export type PentagramsInfoFragment = { __typename: 'pentagramsConnection', edges: Array<{ __typename: 'pentagramsEdge', node: { __typename: 'pentagrams', id: string, description?: string | null, created_at: string, users: { __typename: 'users', mutable_id: string, nickname?: string | null, id: string }, pentagrams_nodesCollection?: { __typename: 'pentagrams_nodesConnection', edges: Array<{ __typename: 'pentagrams_nodesEdge', node: { __typename: 'pentagrams_nodes', id: string, angle: number, distance: number, oeuvres: { __typename: 'oeuvres', id: string, title: string, description?: string | null, release_date: string, oeuvres_artistsCollection?: { __typename: 'oeuvres_artistsConnection', edges: Array<{ __typename: 'oeuvres_artistsEdge', node: { __typename: 'oeuvres_artists', artists: { __typename: 'artists', id: string, name: string, birthdate?: string | null, bio?: string | null } } }> } | null, oeuvres_genresCollection?: { __typename: 'oeuvres_genresConnection', edges: Array<{ __typename: 'oeuvres_genresEdge', node: { __typename: 'oeuvres_genres', genres: { __typename: 'genres', id: string, name?: string | null } } }> } | null } } }> } | null } }> };
