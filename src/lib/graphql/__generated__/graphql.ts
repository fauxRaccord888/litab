...
export type GetUserByIdQuery = { __typename: 'Query', usersCollection?: { __typename: 'usersConnection', edges: Array<{ __typename: 'usersEdge', node: { __typename: 'users', mutable_id?: string | null, id: string } }> } | null };
