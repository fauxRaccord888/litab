...
export type MiniProfileFragment = { __typename: 'users', mutable_id?: string | null, nickname?: string | null, id: string };

export type FollowingsMiniProfileFragment = { __typename: 'usersConnection', edges: Array<{ __typename: 'usersEdge', node: { __typename: 'users', mutable_id?: string | null, nickname?: string | null, id: string } }> };
